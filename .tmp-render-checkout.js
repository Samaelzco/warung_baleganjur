        (() => {
            ...
            const labelInvalidVoucher = "Invalid voucher.";
            const labelVoucherApplied = "Voucher applied.";
            const labelNetwork = "Network issue. Please try again.";
            const labelSubmitFailed = "Failed to submit order. Please try again.";
            ...
            const submitOrder = async () => {
                ...
                try {
                    const res = await fetch("http:\/\/localhost\/AAAAAAAAAA\/checkout\/submit", {
                        method: 'POST',
                    ...
                    if (res.ok && json && json.ok) {
                        writeCart({})
                        writeVoucher('')
                        window.location.href = json.redirect || "http:\/\/localhost\/AAAAAAAAAA\/status";
                        return
                    }
