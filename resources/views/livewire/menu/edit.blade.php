    ...
    public function update(): void
    {
                    ...
                    if (!KategoriMenu::query()
                        ...
                        ->where(function ($query) {
                            $query->where('is_active', true)
                                ->orWhere('id', $this->menu->kategori_id);
                        })
                        ->exists()) {
        ...
        if ($this->gambar) {
            if ($this->menu->gambar) {
                ...
                MenuImageService::deleteThumbnails($this->menu->gambar);
            }
        ...
        $this->menu->addons()->sync($addonIds);
            ...
            <div class="grid gap-6 md:grid-cols-5">
                ...
                <div class="space-y-4 md:col-span-2 md:pl-2">
                    <div class="rounded-2xl border border-neutral-200/70 bg-white p-3 dark:border-neutral-700 dark:bg-neutral-900">
                        ...
                        <div class="mt-3">
                            @if ($gambar)
                                <img src="{{ $gambar->temporaryUrl() }}" alt="preview" class="h-24 w-24 rounded-xl border object-cover" />
                            @elseif ($menu->gambar)
                                <img src="{{ Storage::url($menu->gambar) }}" alt="current" class="h-24 w-24 rounded-xl border object-cover" />
                            @endif
                        </div>
                    </div>
